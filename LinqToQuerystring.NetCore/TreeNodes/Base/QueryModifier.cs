...
namespace LinqToQuerystring.TreeNodes.Base
{
    ...
    public abstract class QueryModifier : TreeNode
    {
        ...
        public override System.Linq.Expressions.Expression BuildLinqExpression(IQueryable query, System.Linq.Expressions.Expression expression, System.Linq.Expressions.Expression item = null)
        {
